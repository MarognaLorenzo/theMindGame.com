/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e9a38f54e36c226316cacd1fbdb7795)
// Runtime types generated with workerd@1.20260801.1 2026-03-07 
interface __BaseEnv_Env {
	DB: D1Database;
	ANALYTICS: AnalyticsEngineDataset;
	ALLOWED_ORIGINS: "https://themindgameonline3-0-pages.pages.dev,http://localhost:3000,https://themindgame.app,https://the-mind-game.com,*.themindgameonline3-0-pages.pages.dev";
	PUBLIC_BASE_URL: "https://the-mind-game-worker-preview.lmarogna02.workers.dev" | "https://the-mind-game-worker.lmarogna02.workers.dev";
	NEXT_PUBLIC_WORKER_URL: string;
	LOBBY_SERVER: DurableObjectNamespace<import("./worker/index").LobbyServer>;
	LOBBY_REGISTRY: DurableObjectNamespace<import("./worker/index").LobbyRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "LobbyServer" | "LobbyRegistry";
	}
	interface PreviewEnv {
		DB: D1Database;
		ANALYTICS: AnalyticsEngineDataset;
		ALLOWED_ORIGINS: "https://themindgameonline3-0-pages.pages.dev,http://localhost:3000,https://themindgame.app,https://the-mind-game.com,*.themindgameonline3-0-pages.pages.dev";
		PUBLIC_BASE_URL: "https://the-mind-game-worker-preview.lmarogna02.workers.dev";
		NEXT_PUBLIC_WORKER_URL: string;
		LOBBY_SERVER: DurableObjectNamespace<import("./worker/index").LobbyServer>;
		LOBBY_REGISTRY: DurableObjectNamespace<import("./worker/index").LobbyRegistry>;
	}
